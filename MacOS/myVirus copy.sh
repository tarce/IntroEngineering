...
whiptail \
--msgbox "You are accessing a U.S. Government Information System classified TOP SECRET.  Please proceed with identification." --title "TOP SECRET -- AUTHORIZED USE ONLY." \
8 70

whiptail --inputbox "Please enter your username:" \
--title "Username Required" \
8 70 

whiptail --passwordbox "Please enter your secret password:" \
